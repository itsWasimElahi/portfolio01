...
//       <div className='max-w-[1000px] mx-auto px-4 md:px-8 flex justify-between items-center h-[80px]'>
//         <div>
...
//             <li>
//               <a
//                 className='flex justify-between items-center w-[160px] h-[60px] text-gray-300 bg-blue-600 hover:ml-[-10px] duration-300'
...
//             <li>
//               <a
//                 className='flex justify-between items-center w-[160px] h-[60px] text-gray-300 bg-[#333333] hover:ml-[-10px] duration-300'
...
//             <li>
//               <a
//                 className='flex justify-between items-center w-[160px] h-[60px] text-gray-300 bg-[#6fc2b0] hover:ml-[-10px] duration-300'
...
//             <li>
//               <a
//                 className='flex justify-between items-center w-[160px] h-[60px] text-gray-300 bg-[#565f69] hover:ml-[-10px] duration-300'
...
//             <FaLinkedin size={30} />
//           </a>
//           <a href="https://github.com/itsWasimElahi" className="mr-4">
//             <FaGithub size={30} />
//           </a>
//           <a
//             href="https://phenomenal-lily-c656cc.netlify.app/"
...
//           </a>
//           <a href="https://drive.google.com/file/d/190odi0oMV2JJYfxzneRYDPWkH55UYN0n/view?usp=sharing">
    ...
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300 z-20">
      ...
      >
        ...
        <div className="flex justify-center mt-8">
          ...
          <a href="https://drive.google.com/file/d/17KxzdkFnC8RSK_WlgpJ1sE4Mp9hcnt07/view?usp=sharing">
            <BsFillPersonLinesFill size={30} />
          </a>
        </div>
      </ul>
      ...
      <div className="hidden lg:flex fixed flex-col top-[35%] left-0">
        <ul>
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#565f69]">
            <a
              className="flex justify-between items-center w-full text-gray-300"
              href="https://drive.google.com/file/d/17KxzdkFnC8RSK_WlgpJ1sE4Mp9hcnt07/view?usp=sharing">   
              Resume <BsFillPersonLinesFill size={30} />
            </a>
          </li>
        </ul>

...
const Home = () => {
  return (
    <div name='home' className='w-full min-h-screen bg-[#0a192f] flex justify-center items-center z-10'>
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col sm:flex-row justify-center items-center'>
        <div className="flex flex-col items-center sm:items-start sm:mr-8">
          <p className='text-pink-600 mt-8 sm:mt-0'>Hi, my name is</p>
          <h1 className='text-4xl sm:text-7xl font-bold text-[#ccd6f6] mt-2 sm:mt-4'>
        ...
        <img src={profileImage} alt="Waseem Elahi" className="rounded-full w-64 h-64 object-cover shadow-md mt-8 transition-transform duration-300 transform hover:scale-110 sm:mt-0 z-10" />
      </div>
    </div>
  );
};
